...
public class GSAboutPanel extends JPanel {
  ...
  public GSAboutPanel() {
    ...
    // create a JLabel with instructions 
    ...
    JLabel imageLabel = new JLabel(icon);  // create another JLabel with image on it
    add(instructionsLabel); // add 2 labels to the panel
    add(imageLabel);
  }
