...
public interface BinaryTree<T> extends Iterable<T>
{
   ...
   public BinryTree();
    ...
    //  Creates a BinaryTree of one node only
   public BinryTree(T element);

       //  Creates a BinaryTree given its root element and its two subtrees
   public BinryTree(T element, BianryTree<T> left, BinaryTree<T> right);
   ...
   //  sets the right subtree of the root.
   public void setRight(BinaryTree<T> t); 
   
   //  sets the left subtree of the root.
